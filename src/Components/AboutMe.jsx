                ...
                <div class="about-me-content" >
                    <div class="left">
                        <div class="about-me-img">
                            <img src="./Images/Mmeyene.jpg" alt=""/>
                        </div> 
                    </div>
                    <div class="right">
                        <p class="text-color">Hello! my name is Mmeyene Aloysius, i am an electrical engineer/ self-taught web developer. I enjoy learning new technologies and utilizing them to solve real-world problems.</p>
