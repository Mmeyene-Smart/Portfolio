    ...
    <section class="skills" id="skills">
            <div class="container">
                ...
                <div class="skills-wrapper">
                    ...
                    <div class="skill-card">
                        <img src="./Images/tailwind-icon.png" alt="" class="s-icons" />  
                        <h3 class="h4">Tailwind css</h3>
                    </div>
                    <div class="skill-card">
                         <img src="./Images/wordpress-icons.jpg" alt="" class="s-icons" />   
                        <h3 class="h4">Word press</h3>
                    </div>
                </div>                
            </div>                
        </section>
